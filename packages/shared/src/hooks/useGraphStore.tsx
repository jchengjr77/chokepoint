...
export function GraphStoreProvider({ children }: { children: ReactNode }) {
  ...
  // navigator.onLine / window online-offline events are browser-only.
  // React Native has neither (Metro doesn't define `navigator` or
  // `window` at all) — this degrades to "always online" until a later
  // phase wires in @react-native-community/netinfo for mobile.
